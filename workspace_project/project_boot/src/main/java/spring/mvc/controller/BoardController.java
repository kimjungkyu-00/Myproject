...
//	}
	...
	@ResponseBody
	public ModelAndView searchList(@RequestParam("searchOption") String searchOption, 
			@RequestParam("searchOption1") String searchOption1,
			@RequestParam("keyword") String keyword) {

		System.out.println("searchOption : " + searchOption);
		System.out.println("keyword :" +keyword);
		List<BoardVO> list = boardService.listAll(searchOption, searchOption1, keyword);
