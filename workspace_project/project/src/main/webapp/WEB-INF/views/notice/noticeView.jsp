						...
						<div class="panel-body">
							...
							<div class="row form-group">
								...
								<textarea class="form-control"  id="textarea_test"
									readonly="readonly" disabled="disabled" >${notice.ncontent}</textarea>
							</div>
		...
		$.ajax({
			...
			data : params,
 			success : function(data){
				...
				$("#contentwriter").attr('type', 'hidden');
 				var html = '<tr data-commentidx='+ data.idx+'</tr>';
				html += '<td><input type="text" id="contentwriter" value="'+params.userid+'"></td>';
