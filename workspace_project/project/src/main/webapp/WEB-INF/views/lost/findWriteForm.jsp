...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/writeBoard.js"></script>
			...
			<form id="findWriteForm" name="findWriteForm" enctype="multipart/form-data">
				<div class="form-group">
					<label>작성자</label> <input type="text" class="form-control"
						id="writer" name="writer" value="${member.userid }" readonly>
				</div>
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>시/도</label> <select class="form-control" id="area"
							name="area">
					...
					<div class="form-group col-md-6">
						<label>날짜</label> <input class="form-control" type="date"
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>견종 </label> <select class="form-control" id="dogKind"
							name="dogKind">
					...
					<div class="form-group col-md-6">
						<label>성별</label> <select class="form-control" id="gender"
							name="gender">
