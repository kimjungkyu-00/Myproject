...
public  class  ClientControl  extends  Frame  implements  ActionListener{
    ...
    Socket  socket;
    public  ClientControl(String  title){                        //  생성자
        super(title);
    ...
    public  static  void  main(String[]  args){
        ...
        ClientControl  client=new  ClientControl("가위바위보  게임");
